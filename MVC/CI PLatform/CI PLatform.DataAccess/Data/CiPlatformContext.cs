...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=PCA158\\SQL2017; Database=ci_platform;TrustServerCertificate=True;User ID=sa;Password=Tatva@123;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Admin>(entity =>
        {
            object p = entity.HasKey(e => e.AdminId).HasName("PK__admin__43AA4141E9F53EF8");
        ...
        {
            entity.HasKey(e => e.BannerId).HasName("PK__banner__10373C3453ADF97F");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__city__031491A87FA857A7");
        ...
        {
            entity.HasKey(e => e.CmsPageId).HasName("PK__cms_page__B46D5B5209C1A010");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__comment__E79576876B40957C");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__country__7E8CD055AF1A3E76");
        ...
        {
            entity.HasKey(e => e.FavoriteMissionId).HasName("PK__favorite__B4CF33126A89B8C9");
        ...
        {
            entity.HasKey(e => e.GoalMissionId).HasName("PK__goal_mis__358E02C75F06648F");
        ...
        {
            entity.HasKey(e => e.MissionId).HasName("PK__mission__B5419AB2085E12D1");
        ...
        {
            entity.HasKey(e => e.MissionApplicationId).HasName("PK__mission___DF92838ABEDA66F3");
        ...
        {
            entity.HasKey(e => e.MissionDocumentId).HasName("PK__mission___E80E0CC8F268D349");
        ...
        {
            entity.HasKey(e => e.MissionInviteId).HasName("PK__mission___A97ED158C932E21A");
        ...
        {
            entity.HasKey(e => e.MissionMediaId).HasName("PK__mission___848A78E849E1AC87");
        ...
        {
            entity.HasKey(e => e.MissionRatingId).HasName("PK__mission___320E51722A4BC65F");
        ...
        {
            entity.HasKey(e => e.MissionSkillId).HasName("PK__mission___82712008842D56DE");
        ...
        {
            entity.HasKey(e => e.MissionThemeId).HasName("PK__mission___4925C5AC589931D0");
        ...
        {
            entity.HasKey(e => e.SkillId).HasName("PK__skill__FBBA83795B59F9E8");
        ...
        {
            entity.HasKey(e => e.StoryId).HasName("PK__story__66339C566546056C");
        ...
        {
            entity.HasKey(e => e.StoryInviteId).HasName("PK__story_in__04497867866663AE");
        ...
        {
            entity.HasKey(e => e.StoryMediaId).HasName("PK__story_me__29BD053C73B7C632");
        ...
        {
            entity.HasKey(e => e.TimesheetId).HasName("PK__timeshee__7BBF50684957A147");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__user__B9BE370F99B6E3E9");
        ...
        {
            entity.HasKey(e => e.UserSkillId).HasName("PK__user_ski__FD3B576BD2B36DC2");
